...
public class PaintActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case MENU_COLOR_WHITE: paintView.set_line_color(Color.WHITE); return true;
            case MENU_COLOR_BLUE: paintView.set_line_color(Color.BLUE); return true;
            case MENU_NEW_IMAGE: paintView.clear(); return true;
            case MENU_SAVE: paintView.save_image(); return true;
        }
