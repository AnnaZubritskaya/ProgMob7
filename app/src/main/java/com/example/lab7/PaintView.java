...
public class PaintView extends View {
    ...
    public void save_image()
    {
        ...
        try {
            ...
            Toast message=Toast.makeText(getContext(),"Збережено! "+getResources().getString(R.string.painting_saved)
        ...
        {
            Toast message=Toast.makeText(getContext(),"Помилка! "+ex.toString(),Toast.LENGTH_SHORT);
            message.setGravity(Gravity.CENTER,message.getXOffset()/2,message.getYOffset()/2);
            message.show();
        }
    }
